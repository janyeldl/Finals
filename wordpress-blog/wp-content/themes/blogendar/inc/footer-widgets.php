...
class  Blogendar_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'blogendar';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'blogendar' ), $i ),
...
// Initialize.
$blogendar_footer_widgets = new  Blogendar_Footer_Widgets();
