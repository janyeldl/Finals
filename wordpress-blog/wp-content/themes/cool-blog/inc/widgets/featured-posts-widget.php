<?php
if ( ! class_exists( 'Cool_Blog_Featured_Posts_Widget' ) ) {
	/**
	 * Adds Cool Blog Featured Posts Widget.
	 */
	class Cool_Blog_Featured_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct(
				'cool_blog_featured_posts_widget',
				__( 'Cool Blog: Featured Posts Widget', 'cool-blog' ),
