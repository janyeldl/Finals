<?php
if ( ! class_exists( 'Cool_Blog_Social_Widget' ) ) {
	/**
	 * Adds Cool Blog Social Widget.
	 */
	class Cool_Blog_Social_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$cool_blog_social_widget = array(
				'classname'   => 'widget adore-widget social-widget',
				'description' => __( 'Retrive Social Widget', 'cool-blog' ),
			);
			parent::__construct(
				'cool_blog_social_widget',
				__( 'Cool Blog: Social Widget', 'cool-blog' ),
				$cool_blog_social_widget
			);
		}
